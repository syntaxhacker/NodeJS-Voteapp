...
form.addEventListener('submit', e=>{
    ...
    fetch('https://nodejsandpusher-jrohit072.cs50.io/poll',{
        method: 'post',
...
fetch('https://nodejsandpusher-jrohit072.cs50.io/poll').then(res => res.json()).then(data => {
        ...
        if(chartContainer){
            ...
            chart.render();
             ...
             Pusher.logToConsole = true;
                ...
                var pusher = new Pusher('5c6a2064e52b7657ce6b', {
                    cluster: 'ap2',
                    forceTLS: true
                });
